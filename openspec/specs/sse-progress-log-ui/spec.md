...
Garantir que o painel de log usado pelas etapas consumidas via SSE reflita
corretamente quando uma operação terminou — em particular, que o indicador
de carregamento (spinner) da última linha de progresso nunca fique girando
indefinidamente depois que o evento `done` é recebido.
